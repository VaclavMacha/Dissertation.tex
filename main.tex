...
% \tikzexternalize[prefix=tmp/figures/,optimize command away=\includepdf]
...
\pgfplotsset{
    ...
    scatterpos/.style   = {only marks, myred, fill = myred, fill opacity = 0.15, mark size=1.5pt},
    scatterneg/.style   = {only marks, myblue, fill = myblue, fill opacity = 0.15, mark size=1.5pt},
}
