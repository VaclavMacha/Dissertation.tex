...
\tikzstyle{bubbleA} = [rectangle, rounded corners, minimum width=2cm, minimum height=1cm,text centered, draw=black, fill=mgreen!70]
...
\begin{restatable}[Goldbach's conjecture]{theorem}{goldbach}\label{thm:goldbach}
...
\begin{equation}\label{eq:defin_surrogate}
  \begin{aligned}
    ...
    % l_{\log}(s) & =\frac{1}{\log2}\log\Brac{1 + e^s}.
  \end{aligned}
\end{equation}
