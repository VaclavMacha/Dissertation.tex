...
The dual formulation from the previous theorem for \TopPush ($K = 1$) was originally derived in~\cite{li2014top}. We only show, that our general dual formulation also covers this special case.
