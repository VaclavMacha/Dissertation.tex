...
\begin{figure}[!ht]
  \begin{tikzpicture}
    ...
    \begin{groupplot}[group style = {group size = 2 by 1, horizontal sep = 10pt}]
        \nextgroupplot[
          title = {Linear Kernel},
          xlabel={$\recall$},
          ylabel={$\precision$},
...
\begin{figure}[!ht]
  \begin{tikzpicture}
    ...
    \begin{groupplot}[
      group style = {group size = 3 by 2, horizontal sep = 5pt, vertical sep = 5pt}
      ]
      \nextgroupplot[
        title={\TopPush},
        legend style = legstyle,
...
\begin{figure}[!ht]
  \begin{tikzpicture}
    ...
    \begin{groupplot}[group style = {group size = 3 by 1, horizontal sep = 10pt}]
        \nextgroupplot[
          title = {\TopPush},
          xlabel={$t \; [s]$},
          ylabel = {objective},
          ...
          \addplot [lineprimal] table[x index=0, y index=1] {\ConvergenceTopPush}; \addlegendentry{primal objective}
          \addplot [linedual]   table[x index=2, y index=3] {\ConvergenceTopPush}; \addlegendentry{dual objective}
          \coordinate (cleft) at (rel axis cs:0,1);
        \nextgroupplot[
          title = {\TopPushK},
          xlabel={$t \; [s]$},
