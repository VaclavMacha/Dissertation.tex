...
\begin{notation}[Dataset]\label{not: dataset}
  ...
  \begin{equation*}
    ...
    \end{aligned}
  \end{equation*}
  We also denote the number of negative samples in~$\D$ as~$n^- = \Brac[v]{\I^-}$ and the number of positive samples in~$\D$ as~$n^+ = \Brac[v]{\I^+},$ i.e. total number of samples is~$n = n^- + n^+.$ 
\end{notation}
