...
\begin{table}
  ...
  \begin{NiceTabular}{lccccc}
    ...
    \TopPushK
      ...
      & $1$
      & $\frac{2}{K}$
      & \Block[fill=mygreen!50]{1-1}{$\frac{1}{2} + \frac{2}{K}$} \\
    \midrule
    \Grill
      & \eqref{eq: grill}
      & $0$
      & $2$
      & $1 - 2\tau$
      & \Block[fill=mygreen!50]{1-1}{$\frac{3}{2} + 2\tau(1-\tau)$} \\
    \TopMeanK
      & \eqref{eq: topmeank}
      & $0$
      & \Block[fill=mygreen!50]{1-1}{$1$}
    ...
    \PatMat
      ...
      & $\frac{1}{\vartheta}(1-\tau)$
      & \Block[fill=mygreen!50]{1-1}{$\frac{1}{2} + \frac{1}{\vartheta}(1-\tau)$} \\
    \midrule
    \GrillNP
      & \eqref{eq: grill np}
      & $0$
      & $2$
      & $-\tau$
      & \Block[fill=mygreen!50]{1-1}{$1 + \frac{1}{2}\tau^2$} \\
    \tauFPL
      & \eqref{eq: tau-fpl}
      & $0$
      & $1$
      & $-\frac{1}{2}\tau$
      & \Block[fill=mygreen!50]{1-1}{$\frac{1}{2} - \frac{1}{8} \tau \Brac{4 + \tau}$} \\
    \PatMatNP
      & \eqref{eq: patmat np}
      & $\frac{1}{\vartheta}(1-\tau)$
      & $1+\frac{1}{\vartheta}(1-\tau)$
