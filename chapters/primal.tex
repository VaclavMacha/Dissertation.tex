...
The decision variables in \eqref{eq: aatp surrogate} are the normal vector of the separating hyperplane~$\bm{w}$ and the threshold~$t$. Since the gradient descent algorith uses the following rule
\begin{equation*}
