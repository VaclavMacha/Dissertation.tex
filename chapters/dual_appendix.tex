...
\begin{proof}
  ...
  \end{align*}
  Now there are two possible choices of~$\delta.$
  \begin{enumerate}
    \item The first choice of~$\delta$ is
    \begin{equation*}
      \delta = \frac{\beta_{\max}}{\vartheta},
    \end{equation*}
    which yields to feasible solution only if~$\betal + \Delta \leq \beta_{\max}.$ Using this condition and the form of~$\delta,$ the constraint~\eqref{eq: Pat dual hinge c3} can be rewritten as~$-\betal \leq \Delta,$ which in combination with~\eqref{eq: Pat dual hinge c2 update a,a} gives the lower and upper bound of~$\Delta.$ Using the update rule~\eqref{eq: update rule a,a}, objective function~\eqref{eq: Pat dual hinge L} can be rewritten as a quadratic function with respect to~$\Delta$ as
    \begin{equation*}
      - \frac{1}{2} \Brac[s]{\K_{kk} + \K_{ll} - \K_{kl} - \K_{lk}} \Delta^2
    ...
    \item The second possible choice of~$\delta$ is
    \begin{equation*}
      \delta = \frac{\betal + \Delta}{\vartheta},
    \end{equation*}
    which yields to feasible solution only if~$\betal + \Delta \geq \beta_{\max}.$ Using this condition and the form of~$\delta,$ the constraint~\eqref{eq: Pat dual hinge c3} can be rewritten as~$-\betal \leq \Delta,$ which in combination with~\eqref{eq: Pat dual hinge c2 update a,a} gives the lower and upper bound of~$\Delta.$ Using the update rule~\eqref{eq: update rule a,a}, objective function~\eqref{eq: Pat dual hinge L} can be rewritten as a quadratic function with respect to~$\Delta$ as
    \begin{equation*}
      - \frac{1}{2} \Brac[s]{\K_{kk} + \K_{ll} - \K_{kl} - \K_{lk}} \Delta^2
  ...
  \end{enumerate}
  The final optimal solution is the one that is feasible and that maximizes the original objective function~\eqref{eq: Pat dual hinge L}. Note that both choices of~$\delta$ lead to the same bounds of~$\Delta.$
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    0 \leq \betal - \Delta & \leq \delta \vartheta.
  \end{align*}
  Now there are three possible choices of~$\delta.$
  \begin{enumerate}
    \item The first choice of~$\delta$ is
    \begin{equation*}
      \delta = \frac{\beta_{\max}}{\vartheta},
    \end{equation*}
    which yields to feasible solution only if~$\beta_{\max} \geq \max\{\betak + \Delta, \betal - \Delta.$ Using this condition and the form of~$\delta,$ the constraint~\eqref{eq: Pat dual hinge c3} can be rewritten as~$-\betak \leq \Delta \leq \betal,$ which gives the lower and upper bound of~$\Delta.$ Using the update rule~\eqref{eq: update rule a,a}, objective function~\eqref{eq: Pat dual hinge L} can be rewritten as a quadratic function with respect to~$\Delta$ as
    \begin{equation*}
      - \frac{1}{2} \Brac[s]{\K_{kk} + \K_{ll} - \K_{kl} - \K_{lk}} \Delta^2
      - \Brac[s]{s_k - s_l} \Delta
      - c(\bm{\alpha}, \bm{\beta}).
    \end{equation*}
    The optimal solution~$\Delta^{\star}_1$ is given by~\eqref{eq: Delta optimal} and is feasible if~$\beta_{\max} \geq \max\{\betak + \Delta^{\star}_1 \betal - \Delta^{\star}_1.$.

    \item The second possible choice of~$\delta$ is
    \begin{equation*}
      \delta = \frac{\betak + \Delta}{\vartheta},
    \end{equation*}
    which yields to feasible solution only if~$\betak + \Delta \geq \max\{\beta_{\max} , \betal - \Delta\}$, Using this condition and the form of~$\delta,$ the constraint~\eqref{eq: Pat dual hinge c3} can be rewritten as~$-\betak \leq \Delta \leq \betal,$ which gives the lower and upper bound of~$\Delta.$ Using the update rule~\eqref{eq: update rule a,a}, objective function~\eqref{eq: Pat dual hinge L} can be rewritten as a quadratic function with respect to~$\Delta$ as
    \begin{equation*}
      - \frac{1}{2} \Brac[s]{\K_{kk} + \K_{ll} - \K_{kl} - \K_{lk}} \Delta^2
      - \Brac[s]{s_k - s_l + \frac{\ntil \tau}{\vartheta}} \Delta
      - c(\bm{\alpha}, \bm{\beta}).
    \end{equation*}
    The optimal solution~$\Delta^{\star}_2$ is given by~\eqref{eq: Delta optimal} and is feasible if~$\betak + \Delta^{\star}_2 \geq \max\{\beta_{\max} , \betal - \Delta^{\star}_2\}$.

    \item The third possible choice of~$\delta$ is
    \begin{equation*}
      \delta = \frac{\betal - \Delta}{\vartheta},
    \end{equation*}
    which yields to feasible solution only if~$\betal - \Delta \geq \max\{\beta_{\max} , \betak + \Delta\}$, Using this condition and the form of~$\delta,$ the constraint~\eqref{eq: Pat dual hinge c3} can be rewritten as~$-\betak \leq \Delta \leq \betal,$ which gives the lower and upper bound of~$\Delta.$ Using the update rule~\eqref{eq: update rule a,a}, objective function~\eqref{eq: Pat dual hinge L} can be rewritten as a quadratic function with respect to~$\Delta$ as
    \begin{equation*}
      - \frac{1}{2} \Brac[s]{\K_{kk} + \K_{ll} - \K_{kl} - \K_{lk}} \Delta^2
      - \Brac[s]{s_k - s_l - \frac{\ntil \tau}{\vartheta}} \Delta
      - c(\bm{\alpha}, \bm{\beta}).
    \end{equation*}
    The optimal solution~$\Delta^{\star}_3$ is given by~\eqref{eq: Delta optimal} and is feasible if~$\betal - \Delta^{\star}_3 \geq \max\{\beta_{\max}, \betak + \Delta^{\star}_3\}$.
  \end{enumerate}
  The final optimal solution is the one that is feasible and that maximizes the original objective function~\eqref{eq: Pat dual hinge L}. Note that all choices of~$\delta$ lead to the same bounds of~$\Delta.$
\end{proof}
