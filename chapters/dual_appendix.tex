...
\begin{lemma}[$\updateaa$ for Theorem~\ref{thm: Top dual} with quadratic hinge loss]
...
\begin{lemma}[$\updateab$ for Theorem~\ref{thm: Top dual} with quadratic hinge loss]
...
\begin{lemma}[$\updatebb$ for Theorem~\ref{thm: Top dual} with quadratic hinge loss]
...
\begin{lemma}[$\updateaa$ for Theorem~\ref{thm: Pat dual} with hinge loss]
  For any~$1\le k, l \le \npos$ we have
  \begin{align*}
    \Delta_{lb} & = \min\{- \alphak,\; \alphal - C\}, \\
    \Delta_{ub} & = \max\{C - \alphak,\; \alphal\}, \\
...
\begin{lemma}[$\updateab$ for Theorem~\ref{thm: Pat dual} with hinge loss]
  For any~$1 \le k \le \npos$ and~$\npos + 1 \le l \le \npos + \ntil$ we define~$\hat{l} = l - \npos$ and
  \begin{equation*}
    \beta_{\max}
...
\begin{lemma}[$\updatebb$ for Theorem~\ref{thm: Pat dual} with hinge loss]
  For any~$\npos + 1\le k,l \le \npos + \ntil$ we define~$\hat{k} = k - \npos,$~$\hat{l} = l - \npos$ and
  \begin{equation*}
    \beta_{\max}
...
\begin{lemma}[$\updateaa$ for Theorem~\ref{thm: Pat dual} with quadratic hinge loss]
  If~$1\le k, l \le \npos$, then we have
  \begin{align*}
    \Delta_{lb} & = -\alphak, \\
    \Delta_{ub} & = \alphal, \\
...
\begin{lemma}[$\updateab$ for Theorem~\ref{thm: Pat dual} with quadratic hinge loss]
...
\begin{lemma}[$\updatebb$ for Theorem~\ref{thm: Pat dual} with quadratic hinge loss]
