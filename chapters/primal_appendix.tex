\chapter{Additional materials Chapter~\ref{chap: linear}}
...
\subsection{Stability}\label{app: stability}

In this section, we derive the results presented in Section~\ref{sec: stability} more properly. 
\degeneratebehavior*
...
\subsection{Threshold comparison}\label{app:relations}
