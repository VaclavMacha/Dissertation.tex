...
\end{enumerate}
Assumptions~\ref{ass_alpha1}-\ref{ass_alpha3} are satisfied for example for
\begin{equation*}
...
\begin{figure}[t]
  ...
  \caption{Comparison of hinge loss and its smoothened version.}
