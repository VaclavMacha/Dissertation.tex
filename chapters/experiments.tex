...
\subsection{Experimnt setup}\label{subsec: exp setup}
...
In the previous section, we introduce critical difference diagrams, that can be used to compare multiple formulations across multiple dataset. However, the obtained results shows only the relative performace between the considered formulations. ???
...
\begin{table}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lccccccc}
      ...
      \BaseLine
        ...
        & \Block[fill=mygreen!50]{1-1}{1.40}
        & \Block[fill=myred!50]{1-1}{2.00}
        & 0.04
        & \Block[fill=myred!50]{1-1}{0.02}\\
      \TopPush
        & 89.38
        & \Block[fill=mygreen!50]{1-1}{93.70}
        & 2.25
        & \Block[fill=myred!50]{1-1}{0.40}
        & 4.00
        & \Block[fill=myred!50]{1-1}{0.02}
        & \Block[fill=myred!50]{1-1}{0.02}\\
      \TopPushK(5)
      ...
      \tauFPL(0.05)
        ...
        & 3.60
        & 1.00
        & \Block[fill=mygreen!50]{1-1}{5.50}
        & 0.04
        & \Block[fill=mygreen!50]{1-1}{0.09}\\
      \PatMatNP(0.01)
        & 87.88
        & 92.75
        & \Block[fill=mygreen!50]{1-1}{5.00}
        & 1.10
        & 4.00
        & 0.12
        & \Block[fill=mygreen!50]{1-1}{0.09}\\
  ...
  \caption{Results for the $\tpratk =10$ metric. All results are given as percentages. Each column corresponds to one dataset and each row to one formulation. For each dataset and formulation pair, the result presented is the median from ten separate runs. The best result for each dataset is highlighted in green, while the worst result is highlighted in red.}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lccccccc}
      ...
      \TopPush
        ...
        & \Block[fill=myred!50]{1-1}{98.30}
        & \Block[fill=myred!50]{1-1}{31.10}
        & \Block[fill=myred!50]{1-1}{16.30}
        & 43.50
      ...
      \PatMatNP(0.05)
        & \Block[fill=mygreen!50]{1-1}{99.65}
        & \Block[fill=mygreen!50]{1-1}{99.40}
        & \Block[fill=mygreen!50]{1-1}{46.80}
        & \Block[fill=mygreen!50]{1-1}{34.80}
        & \Block[fill=mygreen!50]{1-1}{58.50}
        & \Block[fill=mygreen!50]{1-1}{9.34}
        & 12.25\\
      \bottomrule
    \end{NiceTabular}
  }
  \caption{Results for the $\tpratfpr = 0.05$ metric. All results are given as percentages. Each column corresponds to one dataset and each row to one formulation. For each dataset and formulation pair, the result presented is the median from ten separate runs. The best result for each dataset is highlighted in green, while the worst result is highlighted in red.}
...
\begin{table}
  ...
  \caption{Results for the $\auroc$ metric. All results are given as percentages. Each column corresponds to one dataset and each row to one formulation. For each dataset and formulation pair, the result presented is the median from ten separate runs. The best result for each dataset is highlighted in green, while the worst result is highlighted in red.}
...
\begin{table}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lcccccc}
      ...
      \SVM
        & 97.89
        & \Block[fill=mygreen!50]{1-1}{95.40}
        & 9.10
        & 4.90
        & \Block[fill=mygreen!50]{1-1}{11.50}
        & 4.52 \\
      \TopPush
        & 97.62
        & 94.80
        & 10.45
        & \Block[fill=mygreen!50]{1-1}{6.10}
        & 11.00
        & 5.23 \\
      \TopPushK(5)
        & 97.97
      ...
      \tauFPL(0.01)
        ...
        & 95.05
        & \Block[fill=mygreen!50]{1-1}{10.70}
        & 5.90
        & 10.5
        & \Block[fill=mygreen!50]{1-1}{5.25} \\
      \tauFPL(0.05)
        & 92.56
        & \Block[fill=myred!50]{1-1}{92.20}
        & 10.15
        & 5.10
        & 10.0
        & 5.24 \\
      \PatMatNP(0.01)
        ...
        & 1.40
        & \Block[fill=myred!50]{1-1}{5.00}
        & \Block[fill=myred!50]{1-1}{4.02} \\
      \PatMatNP(0.05)
        & \Block[fill=myred!50]{1-1}{52.60}
        & 92.50
        & \Block[fill=myred!50]{1-1}{7.45}
        & \Block[fill=myred!50]{1-1}{1.30}
        & \Block[fill=myred!50]{1-1}{5.00}
        & 4.05 \\
      \bottomrule
    \end{NiceTabular}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lcccccc}
      ...
      \SVM
        ...
        & 98.90
        & 60.00
        & \Block[fill=mygreen!50]{1-1}{44.80}
        & 59.00
      ...
      \tauFPL(0.05)
        & 99.74
        & \Block[fill=mygreen!50]{1-1}{99.10}
        & \Block[fill=mygreen!50]{1-1}{60.80}
        & 44.40
        & 61.00
        & \Block[fill=mygreen!50]{1-1}{74.26} \\
      \PatMatNP(0.01)
        & \Block[fill=myred!50]{1-1}{99.30}
        & \Block[fill=myred!50]{1-1}{98.10}
        & \Block[fill=myred!50]{1-1}{54.70}
        & 44.60
        & 62.50
        & 63.47 \\
      \PatMatNP(0.05)
        ...
        & \Block[fill=myred!50]{1-1}{54.70}
        & 44.50
        & \Block[fill=mygreen!50]{1-1}{63.50}
        & 63.48 \\
      \bottomrule
    \end{NiceTabular}
  }
...
\begin{table}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lcccccc}
      ...
      \tauFPL(0.05)
        & 99.93
        & \Block[fill=mygreen!50]{1-1}{99.80}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lccccccc}
      ...
      \BaseLine
        ...
        & \Block[fill=mygreen!50]{1-1}{98.10}
        & 11.40
        & 3.50
        & 5.00
        & 11.34
      ...
      \DeepTopPush
        & 98.42
        & 97.60
        & \Block[fill=myred!50]{1-1}{0.20}
        & 0.20
        & \Block[fill=myred!50]{1-1}{0.00}
      ...
      \TopPushK(10)
        ...
        & 96.90
        & 12.55
        & \Block[fill=mygreen!50]{1-1}{100.00}
        & \Block[fill=mygreen!50]{1-1}{100.00}
        & \Block[fill=mygreen!50]{1-1}{100.00}
        & \Block[fill=mygreen!50]{1-1}{100.00} \\
      \tauFPL(0.01)
...
\begin{table}
  ...
  \resizebox{\columnwidth}{!}{% 
    \begin{NiceTabular}{lccccccc}
      ...
      \BaseLine
        & \Block[fill=mygreen!50]{1-1}{100.00}
        & \Block[fill=mygreen!50]{1-1}{99.90}
        & 83.35
        & 48.00
        & 82.00
        & 94.66
      ...
      \PatMatNP(0.05)
        ...
        & \Block[fill=mygreen!50]{1-1}{57.70}
        & \Block[fill=mygreen!50]{1-1}{85.00}
        & \Block[fill=mygreen!50]{1-1}{95.53}
        & \Block[fill=mygreen!50]{1-1}{98.50} \\
      \bottomrule
    \end{NiceTabular}
  }
  \caption{Results for the $\tpratfpr = 0.05$ metric. All results are given as percentages. Each column corresponds to one dataset and each row to one formulation. For each dataset and formulation pair, the result presented is the median from ten separate runs. The best result for each dataset is highlighted in green, while the worst result is highlighted in red.}
...
\begin{table}[!ht]
  ...
  \begin{NiceTabular}{lccccccc}
    ...
    \midrule
    \BaseLine
    & \Block[fill=myred!50]{1-1}{95.84}
    & \Block[fill=myred!50]{1-1}{0.0}
    & \Block[fill=myred!50]{1-1}{0.0}
    & \Block[fill=myred!50]{1-1}{0.0}
    & \Block[fill=myred!50]{1-1}{0.0}
    & \Block[fill=myred!50]{1-1}{0.02}
    & \Block[fill=myred!50]{1-1}{0.7} \\
    \DeepTopPush
    & 98.29
    & \Block[fill=mygreen!50]{1-1}{5.07}
    & \Block[fill=mygreen!50]{1-1}{35.48}
    & \Block[fill=mygreen!50]{1-1}{57.66}
    & \Block[fill=mygreen!50]{1-1}{48.65}
    & 89.56
    & 93.67 \\
    \PatMatNP($10^{-5}$)
    & 98.81
    ...
    & 47.24
    & 35.28
    & \Block[fill=mygreen!50]{1-1}{91.9}
    & 95.84 \\
    \PatMatNP($10^{-4}$)
    & 98.98
    & \Block[fill=myred!50]{1-1}{0.0}
    ...
    & 1.78
    & 79.76
    & \Block[fill=mygreen!50]{1-1}{96.18} \\
    \PatMatNP($10^{-3}$)
    & \Block[fill=mygreen!50]{1-1}{99.26}
    & \Block[fill=myred!50]{1-1}{0.0}
    & \Block[fill=myred!50]{1-1}{0.0}
...
\begin{table}[!ht]
  ...
  \begin{NiceTabular}{lccccccc}
    ...
    \BaseLine
      & 97.5
      & \Block[fill=myred!50]{1-1}{13.52}
      & \Block[fill=myred!50]{1-1}{24.65}
      & \Block[fill=myred!50]{1-1}{29.54}
      & \Block[fill=myred!50]{1-1}{27.28}
      & \Block[fill=myred!50]{1-1}{44.58}
      & \Block[fill=myred!50]{1-1}{63.84} \\
    \DeepTopPush
      & \Block[fill=myred!50]{1-1}{97.26}
      & \Block[fill=mygreen!50]{1-1}{34.25}
      & \Block[fill=mygreen!50]{1-1}{42.57}
      & \Block[fill=mygreen!50]{1-1}{47.3}
      & \Block[fill=mygreen!50]{1-1}{43.59}
      & 60.42
      & 73.67 \\
    \PatMatNP($10^{-5}$)
      & 97.66
    ...
    \PatMatNP($10^{-4}$)
      ...
      & 77.43 \\
    \PatMatNP($10^{-3}$)
      & \Block[fill=mygreen!50]{1-1}{98.0}
      & 26.99
      & 38.76
      & 44.83
      & 42.17
      & \Block[fill=mygreen!50]{1-1}{64.5}
      & \Block[fill=mygreen!50]{1-1}{78.11} \\
    \bottomrule
  \end{NiceTabular}
