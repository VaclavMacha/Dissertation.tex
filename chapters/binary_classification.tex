...
In the introduction, we briefly described how to find the best classifier. However, this process is more complicated in the real world. We can split this process into the following four phases:
\begin{itemize}
