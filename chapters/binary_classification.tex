...
\begin{itemize}
  ...
  \item \textbf{Inference:} In the previous phases, we trained multiple classifiers and selected the best one for our specific task. In the inference phase, we apply this classifier to actual unlabeled data.
\end{itemize}
