...
\newcommand*{\ListOfPublications}{
  ...
  % Header
  \noindent
  \begin{minipage}[c][0.20\textheight]{0.20\textwidth}
    \includegraphics[width=\textwidth]{images/logocvut.pdf}
  \end{minipage}
  \begin{minipage}[c][0.20\textheight]{0.59\textwidth}
    \centering \doccol \large
    \textbf{Czech Technical University in Prague} \par
    \textbf{Faculty of Nuclear Sciences and} \par
    \textbf{Physical Engineering}
  \end{minipage}
  \begin{minipage}[c][0.20\textheight]{0.20\textwidth}
    \includegraphics[width=\textwidth]{images/logofjfi.pdf}
  \end{minipage}
  % title
